...
public class ReportService {
    ...
    public ReportDto.FinancialReportDto getFinancialReport(LocalDate startDate, LocalDate endDate) {
        ...
        List<SalesOrder> orders = orderRepository.filterOrders(null, null, null, null, start, end, null, PageRequest.of(0, 1000)).getContent();
    ...
    private List<ReportDto.MonthlySalesTrend> buildMonthlyTrends() {
        ...
        for (int i = 5; i >= 0; i--) {
            ...
            List<SalesOrder> orders = orderRepository.filterOrders(null, null, null, null, monthStart, monthEnd, null, PageRequest.of(0, 10000)).getContent();
