...
INSERT INTO card_batches (batch_number, denomination_id, quantity, total_face_value, status, generated_at, expiry_date, notes, created_by)
VALUES 
('BATCH-50-202601', 1, 100, 5000.00, 'AVAILABLE', CURRENT_TIMESTAMP, DATE_ADD(CURRENT_DATE, INTERVAL 365 DAY), 'Initial production batch of ৳50 cards', 'admin'),
('BATCH-100-202601', 2, 200, 20000.00, 'AVAILABLE', CURRENT_TIMESTAMP, DATE_ADD(CURRENT_DATE, INTERVAL 365 DAY), 'Initial production batch of ৳100 cards', 'admin'),
('BATCH-200-202601', 3, 100, 20000.00, 'AVAILABLE', CURRENT_TIMESTAMP, DATE_ADD(CURRENT_DATE, INTERVAL 365 DAY), 'Initial production batch of ৳200 cards', 'admin'),
('BATCH-500-202601', 4, 50, 25000.00, 'AVAILABLE', CURRENT_TIMESTAMP, DATE_ADD(CURRENT_DATE, INTERVAL 730 DAY), 'Initial production batch of ৳500 cards', 'admin');
